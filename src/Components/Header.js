...
function Header(){
  return(
    <div>
      <header id="showcase">
        <h1 style={{color: '#ECF0F1'}}>Hey, I am Suman</h1>
        <p style={{color: '#ECF0F1'}}>I am a javascript developer.Enjoy learning new things and love to work/contribute on open source development.</p>
